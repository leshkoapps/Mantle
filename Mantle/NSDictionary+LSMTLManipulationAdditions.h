//
//  NSDictionary+LSMTLManipulationAdditions.h
//  Mantle
//
...
@interface NSDictionary (LSMTLManipulationAdditions)
...
@interface NSDictionary (LSMTLManipulationAdditions_Deprecated)
